...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        County_results = (f"{county_name}: {Countyvotespercentage:.1f}%,({Countyvotes:,})\n")
        ...
        if (Countyvotes > County_count) and (Countyvotespercentage > County_percentage):
            County_count=Countyvotes
            County_percentage=Countyvotespercentage
